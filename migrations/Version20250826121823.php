 ...
 */
final class Version20250826121823 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie CHANGE id_sortie organisateur_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie CHANGE organisateur_id id_sortie INT NOT NULL');
    }
}
